...
(*{0,0,1,z},*)
(*{0,0,0,1}};*)
(*inertiaTensor[xFrom_,xTo_,yFrom_,yTo_,zFrom_,zTo_,p_]:=Module[{x,y,z,Ixx,Iyy,Izz,Ixy,Ixz,Iyz,integral},integral[f_]:=Integrate[f p,{z,zFrom,zTo},{y,yFrom,yTo},{x,xFrom,xTo}];Ixx=integral[y^2+z^2];Iyy=integral[x^2+z^2];Izz=integral[x^2+y^2];Ixy=integral[x y];Ixz=integral[x z];Iyz=integral[y z];{{Ixx,-Ixy,-Ixz},{-Ixy,Iyy,-Ixz},{-Ixz,-Iyz,Izz}}//Simplify*)
(*];*)
